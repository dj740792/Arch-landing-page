  ...
  return (
    <section className="w-full min-h-screen flex  justify-center px-8 lg:px-16 pt-38">
      <motion.div className=" w-full flex flex-col gap-4 md:gap-8 lg:gap-12">
        ...
        <div className="mt-12 md:mt-16 grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 items-start">
          <div className="md:col-span-4 text-sm xl:text-xl opacity-90 ">
            Based in New Delhi, <br />
            India
          </div>

          <div className="md:col-span-8">
            <p className="text-base sm:text-lg md:text-xl xl:text-2xl font-normal leading-relaxed ">
